...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <Image source={require('../Images/inno.png')} style={{marginLeft:150 ,height:70, width:70, marginTop:45}}></Image>
      <TouchableOpacity onPress={()=>navigation.navigate('Profile')}>
      <Image source={require('../Images/profile.png')} style={{marginTop:45,marginLeft:40}}></Image>
      </TouchableOpacity>
      </View>
      <Image source={require('../Images/ping.png')} style={styles.mainpic}></Image>
