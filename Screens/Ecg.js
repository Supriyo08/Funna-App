...
const Ecg =() => {
  ...
  return(
    <View style = {styles.header}>
          <Image source={require('../Images/ReturnBack.jpeg')} style={{width:40,height:37,marginTop:3, marginRight:11}}></Image>
      ...
      <View style={styles.boxContainer}>
        <View style={styles.box}>
          <View style={styles.inner}>
            <Image source={require('../Images/Heart.png')} style={{ width: 200, height: 200,}}></Image>
        ...
        <Image source={require('../Images/70bm.gif')} style={styles.leadposition}></Image>
      </View>
